  ...
  <div class="collapse navbar-collapse" id="header-navbar">
	<form class="navbar-form visible-xs" action="/Search" method="post">
	  <div class="input-group">
		<input type="text" name="keywords" class="form-control" placeholder="请输入关键字" maxlength="20" autocomplete="off">
...
<div class="content">
  ...
  <article class="excerpt-minic excerpt-minic-index">
		<h2><span class="red">【顶置】</span><a target="_blank" href="/home/index/show?id=75" title="Linux(Centos7.2)配置Laravel开发环境及git中laravel项目的部署" >Linux(Centos7.2)配置Laravel开发环境及git中laravel项目的部署</a>
		</h2>
		<p class="note">一、配置linux的lamp环境及解析两个虚拟主机，Linux系统Lamp环境的配置，这里不再详细说明，有需求的可以看以前的博客，或者更偷懒一些，使用一键安装脚本，阿里云主机的，可以使用镜像市场的PHP环境。有一点需要注意，Laravel框架的网站入口为框架目录中的public目录，所以在配置虚拟主机时...</p>
	</article>
  <div class="title">
	<h3>最新发布</h3>
<!-- 		<div class="more">                
...
<div class="widget widget_sentence">
  ...
  <div class="widget-sentence-link">
	<a href="http://www.thinkphp.cn/" title="ThinkPHP官网" target="_blank" >ThinkPHP官网</a>&nbsp;&nbsp;&nbsp;<a href="https://laravel-china.org/" title="Laravel社区" target="_blank" >Laravel社区</a>&nbsp;&nbsp;&nbsp;<a href="http://ckplayer.com/" title="ckplayer" target="_blank" >ckplayer</a>&nbsp;&nbsp;&nbsp;<a href="http://www.ijquery.cn/" title="jQuery库" target="_blank" >jQuery库</a>
  </div>
</div>
</aside>
</section>
<footer class="footer">
<div class="container">
<p>Copyright &copy; 2014-2016.ZHQ All rights reserved.<a target="_blank" href="#">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
</div>
